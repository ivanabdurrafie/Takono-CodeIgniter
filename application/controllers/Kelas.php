...
class Kelas extends CI_Controller {
    ...
    {
        $data['title'] = "Detail Data Kelas | Takono. Forum Tanya Jawab Sekolah";
        $data['judulHalaman'] = "Detail Data Kelas";
        $data['keteranganHalaman'] = "Halaman detail data kelas siswa";
        $data['iconHalaman'] = "ik-grid";
        $data['breadcrumbs'] = "Kelas / Detail Data Kelas";
        $this->load->view('template/header', $data);
        $this->load->view('template/wrapper-admin');
        $this->load->view('template/sidebar-admin');
        $this->load->view('template/breadcrumbs');
