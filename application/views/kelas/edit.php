    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body font-weight-bold">
                <form action="<?= base_url() ?>kelas/edit/<?= $kelas[0]->id_kelas ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <?php else : ?>
                        <div class="form-group">
                            <label for="nis">Nama Kelas : </label>
                            <input type="text" class="form-control" id="kelas" placeholder="Masukkan nama kelas" name="kelas" value="<?= $kelas[0]->kelas ?>">
                        </div>
                    <?php endif ?>
            </div>
